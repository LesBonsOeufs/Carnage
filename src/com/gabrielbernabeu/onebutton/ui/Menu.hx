...
import com.gabrielbernabeu.utils.ui.UIPositionable;
...
class Menu extends AnimatedScreen 
{
	...
	{
		mcMask.visible = true;
		Actuate.tween(mcMask, 0.7, {alpha: 0}).ease(Cubic.easeIn).reverse().onComplete(function () {GameManager.start(true); });
